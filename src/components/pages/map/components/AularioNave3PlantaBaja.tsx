  ...
  return(
    <>
      <svg  className="svg-container"
        ...
        {/* A17 */}
        <g onClick={()=>handleOpen?.(0)} transform="translate(.000001 0)" className={`classRoom ${isSelected(3) ? "selected" : ""}`}>
          <path d="M80.277596,39.238172h244.655514l.16554,42.911613h-28.836108v101.936404h28.670568v43.948748l-244.655514.428984v-189.225749Z" transform="translate(0 0.000001)" fill="#6ba0a8" stroke="#505050" stroke-width="0.7"/>
        ...
        {/* Baños */}
        <g>
          <path d="M296.26254,82.149783h53.518396v101.936404h-53.518396v-101.936404Z" transform="translate(.000002 0.000003)" fill="#b9bdc0" stroke="#505050" stroke-width="0.7"/>
          <text dx="0" dy="0" font-family="&quot;eBHsLTiXjpU1:::Roboto&quot;" font-size="25" font-weight="400" 
        ...
        {/* A16 */}
        <g onClick={()=>handleOpen?.(1)} transform="translate(.000001 0)" className={`classRoom ${isSelected(1) ? "selected" : ""}`}>
        ...
        {/* A15 */}
        <g onClick={()=>handleOpen?.(2)} transform="translate(.000001 0)" className={`classRoom ${isSelected(2) ? "selected" : ""}`}>
