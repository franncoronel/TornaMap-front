    ...
    <>
      <svg  className="svg-container"
        ...
        <g  style={{fill: mapColors.classrooms.fill, stroke: mapColors.classrooms.stroke, strokeWidth: mapColors.classrooms.strokeWidth}}
          ...
          <text dx="0" dy="0" fontFamily="&quot;eBHsLTiXjpU1:::Roboto&quot;" fontSize="25" fontWeight="400"
        ...
        <g style={{fill: mapColors.banios.fill, stroke: mapColors.banios.stroke, strokeWidth: mapColors.banios.strokeWidth}}>
          ...
          <text dx="0" dy="0" fontFamily="&quot;eBHsLTiXjpU1:::Roboto&quot;" fontSize="25" fontWeight="400"
                  ...
                  strokeWidth="0">
                <tspan x='0' y="0" fontWeight="700" strokeWidth="0">B</tspan>
                <tspan x='0' y="16" fontWeight="700" strokeWidth="0">a</tspan>
                <tspan x='0' y="36" fontWeight="700" strokeWidth="0">ñ</tspan>
                <tspan x='0' y="52" fontWeight="700" strokeWidth="0">o</tspan>
                <tspan x='0' y="68" fontWeight="700" strokeWidth="0">s</tspan>
            </text>
            <Toilet
