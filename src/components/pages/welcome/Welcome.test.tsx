...
describe('Welcome Page', () => {
  it('Renderización correcta del componente', async () => {
    ...
    expect(
      screen.getByText(/¡Informate sobre tus materias, aulas y profesores!/i)
    ).toBeInTheDocument()

    //rendering del fondo
    expect(screen.getByTestId('welcome-box')).toHaveStyle(
      'background-image: url("/fondo-tornavias.jpg")'
    )
  })
